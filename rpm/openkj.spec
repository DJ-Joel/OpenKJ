...
BuildRequires:  cmake qt6-qtbase-devel qt6-qtsvg-devel gstreamer1-devel gstreamer1-plugins-base-devel taglib-devel taglib-extras-devel
Requires:       qt6-qtbase qt6-qtsvg gstreamer1 gstreamer1-plugins-good gstreamer1-plugins-bad-free gstreamer1-plugins-ugly-free unzip gstreamer1-libav taglib taglib-extras google-roboto-fonts google-roboto-mono-fonts
