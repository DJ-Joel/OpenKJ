THIS FORK IS WINDOWS BASED ONLY!!!!
...
Database entries for the songs are based on the file naming scheme.  Common naming schemes are included. Custom patterns can also be defined in the program using regular expressions.
